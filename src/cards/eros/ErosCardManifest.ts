...
export const EROS_CARD_MANIFEST = new CardManifest({
  ...
  projectCards: [
    ...
    {cardName: CardName.STARCORE_MINING, Factory: StarCoreMining},
    {cardName: CardName.EM_DRIVE, Factory: EMDrive, compatibility: [GameModule.Colonies, GameModule.Turmoil]},
  ...
  corporationCards: [
    ...
    {cardName: CardName.TRADE_NAVIGATOR, Factory: TradeNavigator, compatibility: GameModule.Colonies},
    {cardName: CardName.BROTHERHOOD_OF_MUTANTS, Factory: BrotherhoodOfMutants, compatibility: GameModule.Turmoil},
  ],
  preludeCards: [
  ],
