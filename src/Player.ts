...
import {BrotherhoodOfMutants} from './cards/eros/corp/BrotherhoodOfMutants';
...
export class Player implements ISerializable<SerializedPlayer> {
  ...
  public getActions() {
    ...
    if (this.isCorporation(CardName.BROTHERHOOD_OF_MUTANTS) && (this.corporationCard as any).isUsed === false) {
      action.options.push(
        new SelectOption('Mutant and Proud (transform all neutral delegates to your delegates)', 'Transform', () => {
          if (this.game.turmoil !== undefined) {
            ...
            (this.corporationCard as any).isUsed = true;
            return undefined;
          }
          return undefined;
        }),
  ...
  public static deserialize(d: SerializedPlayer): Player {
    ...
    if (d.corporationCard !== undefined) {
      ...
      if (player.corporationCard instanceof BrotherhoodOfMutants) {
        if ((d.corporationCard as any).isUsed === true) player.corporationCard.isUsed = true;
      }
    } else {
